...
public class Day2Frame {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        driver.get("file:///C:/Users/CCST/Desktop/Selanium101/DriverFileGiven/iFrameDemo.html");
...
// Frame 3
        ...
        WebElement frame41Emement = driver.findElement(By.id("innerFrameBtn"));
        driver.switchTo().frame(frame41Emement);
        frame41Emement.click();
